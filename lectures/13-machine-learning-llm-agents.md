...
| 0–5 | 前回の復習 |
| 5–17 | 13.1 機械学習とは何か |
| 17–32 | 13.2 ニューラルネットワークと深層学習 |
| 32–55 | 13.3 トランスフォーマと大規模言語モデル |
| 55–70 | 13.4 エージェントAI |
| 70–77 | 13.5 社会的な論点 |
| 77–90 | **全13回のまとめ**（13分） |

最終回なので、まとめに13分を取る。
13回ぶんの「今回の問い」の答えを並べ直し、繰り返し現れた考え方を6つに束ねる。
学生が毎回書いてきたポートフォリオを、ここで見返してもらう。
...
**技術者としての姿勢**: 第1回で、機械が答えを出せることと、
その答えを信用してよいことは違う、と述べた。
ここではもう一段進んで、**「できること」と「してよいこと」も違う**。
