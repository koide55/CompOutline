...
各回の終わりに、**AI と対話して理解度を確かめる**。

| | |
| --- | --- |
| 何をするか | 各回10問。AI からの質問に、自分の言葉で答える |
| 所要時間 | 15〜25分 |
| どこで | ［要記入：URL］ |
| 締切 | ［要記入］ |

対話ログと所見が記録され、教員が見る。**ここで一線をはっきりさせておく。**

> **AI は点数をつけない。成績は教員が判断する。**

AI がするのは、対話の記録と、教員が短時間で判断するための前処理だけである。
理由は第13回で扱うとおり、LLM の評価には再現性・公平性・説明責任の問題があり、
**不利益処分の根拠にはできない**からである。

**借り物の答えは通りにくい。** 質問は、この講義で実際に扱った例を前提に作ってある。
また各回の問6には、**その回が正そうとしている典型的な誤解が仕込んである**。
第1回なら「量子コンピュータなら停止問題も解ける」——今日の 1.3 で答えが出る。
...
使っている言語モデルは研究室の計算機の中だけで動く。
**入力した内容が学外のサービスに送られることはない。**

### 成績評価

［要記入：理解度確認・期末試験・レポートなどの比率］

### 事務

［要記入：教科書・参考書］

［要記入：質問の受け方（オフィスアワー、メールなど）］
